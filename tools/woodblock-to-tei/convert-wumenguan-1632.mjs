...
function emitFileDesc(out) {
    ...
    out.push('          <p><label>Corroborating witness (context, incomplete rights memo):</label> NDL 2537788 無門慧開禪師語錄 (the Wumen-Huikai Record — a collected sayings-record of the same master). Local PDF: C:\\woodblocks\\Wumen_Huikai_NDL_Commons\\NDL2537788_wumen_kai_record.pdf (218,588,120 bytes, SHA-256 518A4F450325B2E3CB707AC2D657C71E33EC3BDF7F855D1B24D1CB4489C674D4). The rights memo for this witness is still marked incomplete in the local source ledger (C:\\woodblocks\\Wumen_Huikai_NDL_Commons\\README.md) — it is cited here as an editorial corroborant for Huikai\'s own voice only, not as a primary authority, and downstream users should independently confirm its provenance before leaning on it.</p>');
    ...
    out.push('        <bibl type="witness-context">NDL 2537788 無門慧開禪師語錄 (Wumen Huikai Recorded Sayings; rights-memo status: incomplete). Local PDF: NDL2537788_wumen_kai_record.pdf (218,588,120 bytes). Used as a tertiary corroborant for Huikai\'s voice only.</bibl>');
